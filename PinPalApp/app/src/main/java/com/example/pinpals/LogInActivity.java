            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        intent.putExtra("reg", PinPals.get(123456).getReg());
                        intent.putExtra("time", PinPals.get(123456).getTime());
                        intent.putExtra("longitude", PinPals.get(123456).getLocation()[1]);
                        intent.putExtra("latitude",  PinPals.get(123456).getLocation()[0]);
